 ...
 * Copyright (c) 2009-2011 by MobileTicTacToe, Inc. All Rights Reserved.
...
//@interface MobileTicTacToeObject : NSObject
//@end

@interface MobileTicTacToeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MobileTicTacToeObject class]])
		{
			for (NSString *key in [[(MobileTicTacToeObject*)o modules] allKeys])
			{
