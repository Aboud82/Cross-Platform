...
@interface MobileTicTacToeObject : KrollCoverageObject {
#else
@interface MobileTicTacToeObject : KrollObject {
#endif
@private
...
extern NSString * MobileTicTacToe$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MobileTicTacToeObject *_mobiletictactoe;
	BOOL shutdown;
