...
// in simulator we redefine to format for MobileTicTacToe Developer console
...
{\
	NSString * exceptionName = [@"org.mobiletictactoe." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mobiletictactoe";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIMobileTicTacToeNativeItemNone = -1, 
	UIMobileTicTacToeNativeItemSpinner = -2,
	UIMobileTicTacToeNativeItemProgressBar = -3,
	
	UIMobileTicTacToeNativeItemSlider = -4,
	UIMobileTicTacToeNativeItemSwitch = -5,
	UIMobileTicTacToeNativeItemMultiButton = -6,
	UIMobileTicTacToeNativeItemSegmented = -7,
	
	UIMobileTicTacToeNativeItemTextView = -8,
	UIMobileTicTacToeNativeItemTextField = -9,
	UIMobileTicTacToeNativeItemSearchBar = -10,
	
	UIMobileTicTacToeNativeItemPicker = -11,
	UIMobileTicTacToeNativeItemDatePicker = -12,
	
	UIMobileTicTacToeNativeItemInfoLight = -13,
	UIMobileTicTacToeNativeItemInfoDark = -14,
	
	UIMobileTicTacToeNativeItemDisclosure = -15,
	
	UIMobileTicTacToeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MobileTicTacToe instances of
