...
/**
 The base class for all MobileTicTacToe modules
 */
...
/**
 MobileTicTacToe Platform calls this method on startup.
 */
-(void)startup;

/**
 MobileTicTacToe Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 MobileTicTacToe Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 MobileTicTacToe Platform calls this method on resume.
 @param sender The sender of the event.
 */
